...
class Test_changeFunction0(unittest.TestCase):
    ...
    def test_0003_overwritePathLibToFalse(self):
        _funcName = sys._getframe(0).f_code.co_name
        print(str(__class__) + ' ' + _funcName)
    ...
    def test_0004_overwritePathLibToTrue(self):
        _funcName = sys._getframe(0).f_code.co_name
        print(str(__class__) + ' ' + _funcName)
    ...
    def test_0005_justRunPackageFunction(self):
        _funcName = sys._getframe(0).f_code.co_name
        print(str(__class__) + ' ' + _funcName)
...
class Test_changeFunction1(unittest.TestCase):
    ...
    def test_0001_justRunPackageFunction(self):
        _funcName = sys._getframe(0).f_code.co_name
        print(str(__class__) + ' ' + _funcName)
